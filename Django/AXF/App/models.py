...
class Main(models.Model):
    ...
    class Meta:
        abstract = True  # 抽象类，不会被生成表,只会被继承
...
'''
得到这些数据点击加号,里面下拉菜单有一个console file选项,选中需要执行的SQL语句,就添加进去了
...
# 购物车
class Cart(models.Model):  # 想当自己写个中间表,一个多对多,使用两个外键,建立中间表
